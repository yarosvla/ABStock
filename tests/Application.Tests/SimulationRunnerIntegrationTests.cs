...
public sealed class SimulationRunnerIntegrationTests
{
    ...
    public async Task StartAsync_EmitsTickWithExchangeSnapshot()
    {
        ...
        try
        {
            ...
            Assert.Equal(124.35m, tick.Snapshot.LastPrice);
            Assert.NotEmpty(tick.OrderBook.Bids);
